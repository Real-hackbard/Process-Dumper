    ...
    begin
      ...
      while (true) do begin
       ...
       if IID.Characteristics=0 then begin
        thunk:=mHandle+IID.FirstThunk+DWord(delta);
       end else begin
...
begin
     ...
     case TypeID of
        ...
        12: Result:='GROUP CURSOR'; 
        14: Result:='GROUP ICON'; 
        16: Result:='VERSION'; 
        2 or $2000: Result:='NEWBITMAP'; 
        4 or $2000: Result:='NEWMENU'; 
        5 or $2000: Result:='NEWDIALOG'; 
     end;
end;
...
var
  ...
  retval: TDateTime;
const
  StartTimeDate='01.01.1970 4:00:00';
begin
  try
    ...
    Result:='The time that the linker produced this file';
  except
  end;  
end;
   ...
   begin
    ...
    if (ACol=0) or (ARow=0) then begin
     if not((ACol=0) and (ARow=0)) then
      TextOut(Rect.Left + Offset, Rect.Top+dy, sgHex.Cells[ACol,ARow])  
    end;
   end;
  end;
begin
