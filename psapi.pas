...
var
  ...
  _GetModuleBaseName: TGetModuleBaseNameA;
  _GetModuleFileNameEx: TGetModuleFileNameExA;
  ...
  _GetMappedFileName: TGetMappedFileNameA;
  _GetDeviceDriverBaseName: TGetDeviceDriverBaseNameA;
  _GetDeviceDriverFileName: TGetDeviceDriverFileNameA;
...
begin
  ...
  begin
    ...
    @_GetModuleBaseNameA := GetProcAddress(hPSAPI, 'GetModuleBaseNameA');
    @_GetModuleFileNameExA := GetProcAddress(hPSAPI, 'GetModuleFileNameExA');
    @_GetModuleBaseNameW := GetProcAddress(hPSAPI, 'GetModuleBaseNameW');
    @_GetModuleFileNameExW := GetProcAddress(hPSAPI, 'GetModuleFileNameExW');
    @_GetModuleBaseName := GetProcAddress(hPSAPI, 'GetModuleBaseNameA');
    ...
    @_GetMappedFileNameA := GetProcAddress(hPSAPI, 'GetMappedFileNameA');
    ...
    @_GetMappedFileNameW := GetProcAddress(hPSAPI, 'GetMappedFileNameW');
    @_GetDeviceDriverBaseNameW := GetProcAddress(hPSAPI, 'GetDeviceDriverBaseNameW');
    @_GetDeviceDriverFileNameW := GetProcAddress(hPSAPI, 'GetDeviceDriverFileNameW');
    @_GetMappedFileName := GetProcAddress(hPSAPI, 'GetMappedFileNameA');
    @_GetDeviceDriverBaseName := GetProcAddress(hPSAPI, 'GetDeviceDriverBaseNameA');
    @_GetDeviceDriverFileName := GetProcAddress(hPSAPI, 'GetDeviceDriverFileNameA');
